...
course.test = function(){
  console.log( require('Jobs/test.json') )
}
...
course.loadCollapsible = function(){
  ...
  var ID = course.loadJSON('CoursesJson/CourseID.json')
  var smallID = ID.slice(0,10);

  smallID.forEach(function(a){
  //ID.forEach(function(a){
    
      var file = './CoursesJson/course' + a + '.json';
      var data = course.loadJSON(file);
      var prop = 'Course ' + a;
